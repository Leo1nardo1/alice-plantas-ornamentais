...
const products = [
  {
    ...
    care: [
      '<i class="fas fa-sun" title="Luz indireta"></i>',
      '<i class="fas fa-tint" title="Rega moderada"></i>',
      '<i class="fas fa-heart" title="Fácil cuidado"></i>'
    ],
    category: "interna",
    badge: "Destaque",
    featured: true
  },
  {
    ...
    care: [
      '<i class="fas fa-star" title="Cuidado intermediário"></i>',
      '<i class="fas fa-cloud" title="Luz indireta"></i>',
      '<i class="fas fa-wind" title="Purifica o ar"></i>'
    ],
    category: "externa",
    featured: true
  },
  {
    ...
    care: [
      '<i class="fas fa-moon" title="Pouca luz"></i>',
      '<i class="fas fa-smile" title="Muito fácil"></i>',
      '<i class="fas fa-wind" title="Purifica o ar"></i>'
    ],
    category: "suculenta",
    featured: true
  },
  {
    ...
    care: [
      '<i class="fas fa-cloud" title="Luz indireta"></i>',
      '<i class="fas fa-spa" title="Umidade alta"></i>',
      '<i class="fas fa-star" title="Cuidado intermediário"></i>'
    ],
    category: "externa",
    featured: false
  },
  {
    ...
    care: [
      '<i class="fas fa-sun" title="Luz indireta"></i>',
      '<i class="fas fa-tint" title="Rega moderada"></i>',
      '<i class="fas fa-thumbs-up" title="Muito fácil"></i>'
    ],
    category: "interna",
    featured: false
  },
        ...
        <div class="product-info">
            <div>
                ...
                <div class="care-icons">
                    ...
                    ${product.care.map(icon => `<div class="care-icon">${icon}</div>`).join('')}
                </div>
            </div>
            <div>
